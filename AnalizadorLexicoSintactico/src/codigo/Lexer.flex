...
/* Curp */
([A-Z]{4}[0-9]{6}[HM][A-Z]{2}[B-DF-HJ-NP-TV-Z]{3}[0-9A-Z]{1}[0-9]{1}) {lexeme=yytext(); return Curp;}

/* RFC */
([A-Z]{4}[0-9]{6}[A-Z0-9]{3}) {lexeme=yytext(); return Rfc;}

/* Fecha Hora */
(0?[1-9]|1[0-9]|2[0-9]|30|31)[-:/](0?[1-9]|1[0-2])[-:/]([0-9]{4})[-](([01]?[0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?) {lexeme=yytext(); return Fecha_hora;}

/* Fecha */
(0?[1-9]|1[0-9]|2[0-9]|30|31)[-:/](0?[1-9]|1[0-2])[-:/]([0-9]{4}) {lexeme=yytext(); return Fecha;}

/* Hora */
(([01]?[0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?) {lexeme=yytext(); return Hora;}
